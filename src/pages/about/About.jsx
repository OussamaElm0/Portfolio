...
export default function About() {
    ...
    return (
      <>
        <div id="about" className='sections about-section'>
          <div className="" data-aos="fade-up">
            <div className="whoiam">
              ...
              <p className="description" data-aos="fade-left">
                ...
                books. I have a perpetual thirst for knowledge, always eager to
                learn and evolve in this dynamic tech landscape. Let's bring
                innovative ideas to life together!
              </p>
            </div>
          </div>
        </div>
